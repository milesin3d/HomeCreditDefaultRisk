...
Alternative Financial Data + Machine Learning Classification = Predicted Loan Repayment
...
## Goals
### Business
Increase the accuracy of whether or not a loan will be repayed.

### Data
1) Develop a connection between the datasets.
2) With this understanding, use the datasets to predict loan repayment.
